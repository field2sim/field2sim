...
{
    return {
        {"initial", 0.0, 0, inet::Coord(0.0, 0.0, 33)},
        {"segment-1-quarter", 0.5, 0, inet::Coord(0.75, -1.0, 33.25)},
        {"segment-1-midpoint", 1.0, 0, inet::Coord(1.5, -2.0, 33.5)},
        {"segment-2-early", 2.5, 0, inet::Coord(2.166666666666667, -4.0, 33.16666666666667)},
        {"segment-2-midpoint", 3.5, 0, inet::Coord(0.5, -4.0, 31.5)},
        {"segment-3-early", 5.5, 0, inet::Coord(-2.0, -2.75, 29.25)},
        {"segment-3-midpoint", 7.0, 0, inet::Coord(-2.0, 1.0, 30)},
        {"terminal-hold", 9.1, 0, inet::Coord(-2.0, 6.0, 31)},
    };
}
...
{
    return {
        {"static-node-0", 0.1, 0, inet::Coord(0.0, 0.0, 33)},
        {"static-node-1", 0.1, 1, inet::Coord(12.5, -8.0, 34)},
        {"static-node-2", 0.1, 2, inet::Coord(-4.0, -15.25, 29)},
    };
}
