...
{
    return {
        {"initial", 0.0, 0, Vector(0.0, 0.0, 33)},
        {"segment-1-quarter", 0.5, 0, Vector(0.75, -1.0, 33)},
        {"segment-1-midpoint", 1.0, 0, Vector(1.5, -2.0, 33)},
        {"segment-2-early", 2.5, 0, Vector(2.1666666665, -4.0, 34)},
        {"segment-2-midpoint", 3.5, 0, Vector(0.5, -4.0, 34)},
        {"segment-3-early", 5.5, 0, Vector(-2.0, -2.75, 29)},
        {"segment-3-midpoint", 7.0, 0, Vector(-2.0, 1.0, 29)},
        {"terminal-hold", 9.1, 0, Vector(-2.0, 6.0, 31)},
    };
}
...
{
    return {
        {"static-node-0", 0.1, 0, Vector(0.0, 0.0, 33)},
        {"static-node-1", 0.1, 1, Vector(12.5, -8.0, 34)},
        {"static-node-2", 0.1, 2, Vector(-4.0, -15.25, 29)},
    };
}
