(function (root, factory) {
  const profileApi = typeof module === 'object' && module.exports
    ...
    : root.Field2SimPropagationProfiles;
  const api = factory(profileApi);
  if (typeof module === 'object' && module.exports) module.exports = api;
  if (root) root.Field2SimPropagationAdapters = api;
  ...
  function buildPropagationIr(profileId, input = {}) {
    ...
    return {
      schema: 'org.field2sim.propagation-ir',
  ...
  function metadataLines(ir, assessment, prefix) {
    ...
    const lines = [
      `${prefix} Generated by Field2Sim propagation adapter schema ${SCHEMA_VERSION}.`,
